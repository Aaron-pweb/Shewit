...
class _$AuthSessionCopyWithImpl<$Res, $Val extends AuthSession>
  ...
  @override
  $Res call({Object? token = null, Object? userId = freezed}) {
    return _then(
      _value.copyWith(
            token: null == token
                ? _value.token
...
class _$AuthSessionImpl implements _AuthSession {
  const _$AuthSessionImpl({required this.token, this.userId});
...
abstract class _AuthSession implements AuthSession {
  const factory _AuthSession({required final String token, final int? userId}) =
      _$AuthSessionImpl;
